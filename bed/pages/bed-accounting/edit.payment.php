...
<head>
    <title>Edit Payment | SFAC Bacoor</title>
        ...
        <nav class="main-header navbar navbar-expand navbar-dark">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="#" class="nav-link disabled text-light">Edit Payment</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                        ...
                        <div class="row justify-content-center mb-4">
                            <div class="col-md-8">
                                <div class="card card-purple shadow-lg">
                                    ...
                                    <!-- form start -->
                                    <?php
                                        $get_payment = mysqli_query($acc,"SELECT * FROM tbl_payments WHERE payment_id = '$payment_id'") or die(mysqli_error($acc));

                                        while ($row = mysqli_fetch_array($get_payment)) {
                                    ?>
                                    <form action="userData/ctrl.editPayment.php<?php echo '?payment_id=' . $payment_id; ?>" method="POST">
                                        <div class="card-body">
                                            <div class="row justify-content-center">
                                                <div class="input-group col-md-6 mb-2">
                                                    ...
                                                    <input type="text" class="form-control" name="payment" id="payment" value="<?php echo $row['payment']; ?>">
                                        ...
                                        <div class="card-footer">
                                            <button type="submit" name="submit" class="btn bg-purple"><i
                                                    class="fas fa-calendar-check m-1"> </i> Edit Payment</button>
                                        </div>
                                    </form>
                                    <?php
                                        }
