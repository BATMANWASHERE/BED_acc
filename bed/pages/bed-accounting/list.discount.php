...
<head>
    <title>Discount List | SFAC Bacoor</title>
        ...
        <nav class="main-header navbar navbar-expand navbar-dark">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="#" class="nav-link disabled text-light">Discount List</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                            ...
                            <div class="col-12">
                                <div class="card shadow">
                                    <div class="card-header bg-navy p-3">
                                        <h3 class="card-title text-lg">Discount List</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                        <form method="GET">
                                        ...
                                        <table id="example2" class="table table-hover">
                                            ...
                                            <tbody class="border-bottom">
                                                <?php $get_user = mysqli_query($acc, "SELECT * FROM tbl_discounts WHERE ay_id = '$ay_id' ORDER BY ay_id") ?>
                                                <tr>
                                                    <?php
                                                    ...
                                                    ?>
                                                        <td><?php echo "Php ".number_format($row['discount'], 2); ?></td>
                                                    <?php
                                                        }
                                                    ?>
                                                    ...
                                                    <td><a href="edit.discount.php<?php echo '?disc_id=' . $id; ?>"
                                                            type="button"
