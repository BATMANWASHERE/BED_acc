...
if (isset($_POST['submit'])) {
    ...
    $fourth_quarter = mysqli_real_escape_string($acc, $_POST['fourth_quarter']);
        ...
        if ($result > 0) {
            ...
            header('location: ../add.installment.dates.php');

        } else {
            $insert_discount = mysqli_query($acc, "INSERT INTO tbl_installment_dates (ay_id, first_semester, second_semester, first_quarter, second_quarter, third_quarter, fourth_quarter) VALUES ('$ay_id', '$first_semester', '$second_semester', '$first_quarter', '$second_quarter', '$third_quarter', '$fourth_quarter')") or die(mysqli_error($acc));
