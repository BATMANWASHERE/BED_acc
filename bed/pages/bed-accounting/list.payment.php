...
<head>
    <title>Payment List | SFAC Bacoor</title>
        ...
        <nav class="main-header navbar navbar-expand navbar-dark">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="#" class="nav-link disabled text-light">Payment List</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                            ...
                            <div class="col-12">
                                <div class="card shadow">
                                    <div class="card-header bg-navy p-3">
                                        <h3 class="card-title text-lg">Payment List</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                        <form method="GET">
                                        ...
                                        <table id="example2" class="table table-hover">
                                            ...
                                            <tbody class="border-bottom">
                                                <?php $get_user = mysqli_query($acc, "SELECT * FROM tbl_payments WHERE ay_id = '$ay_id' ORDER BY ay_id") ?>
                                                <tr>
                                                    <?php
                                                    ...
                                                    <td><a href="edit.payment.php<?php echo '?payment_id=' . $id; ?>"
                                                            type="button"
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body p-3">
                                                                        Are you sure you want to <b><?php echo $row['payment'];?>?
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-secondary"
                                                                            data-dismiss="modal">Close</button>
                                                                        <a href="userData/ctrl.delPayment.php<?php echo '?payment_id=' . $id; ?>"
                                                                            type="button"
