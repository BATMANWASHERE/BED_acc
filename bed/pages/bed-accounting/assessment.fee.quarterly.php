...
<head>
    <title>Assessment Info | SFAC Bacoor</title>
                                ...
                                <div class="card card-purple shadow-lg">
                                    ...
                                    <?php
                                        ...
                                        while ($row = mysqli_fetch_array($get_tuitionInfo)) {
                                            ...
                                            $date_quar_1 = new DateTime($row['date_quar_1']);
                                            $date_quar_2 = new DateTime($row['date_quar_2']);
                                            $date_quar_3 = new DateTime($row['date_quar_3']);
                                            $date_quar_4 = new DateTime($row['date_quar_4']);
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($discount_array as $discounts_value) { //repeats multiple times
                                                            ...
                                                            while ($row10 = mysqli_fetch_array($select_discount)) { //only repeats one time
                                                                ...
                                                                if ($row10['percent'] == 1) {
                                                                    $percent_value = number_format(floor((($row10['discount'] / 100) * $cash_basis) * 100)/ 100, 2, '.', ''); //this took forever king ina
                                                                    $cash_basis = $cash_basis - $percent_value;
                                                                    $upon_enrollment = $upon_enrollment - $percent_value;
        
                                                                } else {
                                                                    
                                                                    $cash_basis = $cash_basis - $row10['discount'];
                                                                    $upon_enrollment = $upon_enrollment - $row10['discount'];
                                                        ...
                                                        $total = $upon_enrollment + $row['first_quar'] + $row['second_quar'] + $row['third_quar'] + $row['fourth_quar'];

                                                        ?>
                                                        <tr>
                                                        <td><b>Total Upon Enrollment amount</b></td>
                                                        <td style="text-align: right;"><b><?php echo number_format($upon_enrollment, 2);?></b></td>
                                                        </tr>
                                                        <?php
                                                        } else {
                                                        ...
                                                        ?>
                                                        <tr>
                                                        <td>First Quater (<b><?php echo $date_quar_1->format('F d, Y') ?>)</td>
                                                        <td style="text-align: right;"><?php echo number_format($row['first_quar'], 2);?></td>
                                                        </tr>
                                                        <tr>
                                                        <td>Second Quarter (<b><?php echo $date_quar_2->format('F d, Y') ?>)</td>
                                                        <td style="text-align: right;"><?php echo number_format($row['second_quar'], 2);?></td>
                                                        </tr>
                                                        <tr>
                                                        <td>Third Quarter (<b><?php echo $date_quar_3->format('F d, Y') ?>)</td>
                                                        <td style="text-align: right;"><?php echo number_format($row['third_quar'], 2);?></td>
                                                        </tr>
                                                        <tr>
                                                        <td>Fourth Quarter (<b><?php echo $date_quar_4->format('F d, Y') ?>)</td>
                                                        <td style="text-align: right;"><?php echo number_format($row['fourth_quar'], 2);?></td>
                                                        </tr>
                                                        <tr>
                                                        <td><b>TOTAL</b></td>
