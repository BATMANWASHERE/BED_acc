                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body p-0">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        ?>
                                                        <tr>
                                                        <td>First Quater (<b><?php echo $first_quarter->format('F d, Y') ?>)</td>
                                                        <td style="text-align: right;"><?php echo number_format($row['first_quar'], 2);?></td>
                                                        </tr>
                                                        <tr>
                                                        <td>Second Quarter (<b><?php echo $second_quarter->format('F d, Y') ?>)</td>
                                                        <td style="text-align: right;"><?php echo number_format($row['second_quar'], 2);?></td>
                                                        </tr>
                                                        <tr>
                                                        <td>Third Quarter (<b><?php echo $third_quarter->format('F d, Y') ?>)</td>
                                                        <td style="text-align: right;"><?php echo number_format($row['third_quar'], 2);?></td>
                                                        </tr>
                                                        <tr>
                                                        <td>Fourth Quarter (<b><?php echo $fourth_quarter->format('F d, Y') ?>)</td>
